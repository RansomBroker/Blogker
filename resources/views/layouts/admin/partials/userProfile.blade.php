                ...
                @table
                  ...
                  @slot('slot')
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="" value="" id="username" class="form-control form-control-sm" placeholder="Yadis">
                    </td>
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="" value="yadisoke@gmail.com" id="email" class="form-control form-control-sm"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="" value="" id="name" disabled class="form-control form-control-sm" placeholder="Yadistira Fajar Ramadhan">
                      </td>
                    </tr>
